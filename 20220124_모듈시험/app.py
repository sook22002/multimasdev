...
@app.route("/data1")
def FlaskData(): # 요청 받음
    keyValue = r"Svm%2B6xr32aOY87UpaVtoSRfzxu03yUkebwz3d2zw37g4v0QhHWhRyBmYXdbMEiFtdzkyTW%2FBzbzm5KdPswBHmw%3D%3D"   
    ...
    jsonData = json.dumps(dataResult.json(), ensure_ascii=False)

    #공공데이터 요청 후 데이터 받기 : flask - request / requests 기능 사용"

    return jsonData # 공공데이터 결과 값 응답
